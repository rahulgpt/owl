...
owl_hashmap_t *owl_hashmap_new(size_t elsize, size_t cap,
                               ...
                               void *udata)
{
    return hashmap_new(elsize, cap, seed0, seed1, hash, compare, elfree, udata);
}
...
owl_hashmap_t *owl_hashmap_new_with_allocator(
    ...
    void *udata)
{
    return hashmap_new_with_allocator(malloc, realloc, free, elsize, cap, seed0, seed1, hash, compare, elfree, udata);
}
...
{
    return hashmap_clear(map, update_cap);
};
...
bool owl_hashmap_scan(owl_hashmap_t *map,
                      bool (*iter)(const void *item, void *udata), void *udata)
{
    return hashmap_scan(map, iter, udata);
}
